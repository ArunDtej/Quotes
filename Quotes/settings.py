...
SECRET_KEY = 'django-insecure-tr@s5%)1j99*dqmsuembno2$+%mim3a3cupu_yl(aj!6qcr0-e'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://8000-idx-quotes-1722526478717.cluster-7ubberrabzh4qqy2g4z7wgxuw2.cloudworkstations.dev'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [TEMPLATES_DIR],  # Add your templates directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
